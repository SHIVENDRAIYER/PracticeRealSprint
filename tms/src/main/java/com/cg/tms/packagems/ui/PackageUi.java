...
public class PackageUi {
	...
	public void start() {
		...
		try {
			...
			Package pack1 = new Package(1, "Local", "diverse and cultural", "Normal", 8500.0);
			packageService.addPackage(pack1);
			displayPackage(pack1);

			Package pack2 = new Package(2, "International", "challenging adventure", "Ultra", 10500.0);
			packageService.addPackage(pack2);
			displayPackage(pack2);

			Package pack3 = new Package(3, "Holiday", "peace and relaxtion", "Deluxe", 12500.0);
